      ...
      <div class="carousel-item_other active">
        <div class="carousel-container_other">
          <div class="container_other">
            ...
            <p class="animate__animated animate__fadeInDown">@lang('message.home') / @lang('message.job_description') </p> 
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app animate__animated animate__fadeInUp">
                  <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-info">
                      <h4><a href="{{route('detailsjobs', $categorie->slug)}}" class="btn btn-primary voir-plus"> @lang('message.parcourir_categorie') </a></h4>
        ...
        <div class="col-lg-3">
          <div class="portfolio-info">
            ...
            <ul>
                ...
                <li><strong><a href="{{route('detailsjobs', $categorie->slug)}}">{{strtoupper($categorie->intitule)}}</a></strong>
