      ...
      <div class="carousel-item_other active">
        <div class="carousel-container_other">
          <div class="container_other">
            ...
            <p class="animate__animated animate__fadeInDown">@lang('message.home') / @lang('message.bibliotheque') </p> 
        ...
        <div class="col-lg-9">
          ...
          <section id="portfolio" class="section-bg ">
              <div class="container">
                ...
                <form action="{{ route('categorie_bibliotheque_search', ['lang'=>$lang]) }}" method="GET" autocomplete="off">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app animate__animated animate__fadeInUp">
                  <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-info">
                     {{-- <h4 style="color: #0f6db2" class="p-3">  @lang('livres')</h4> --}} 

                      <h4><a href="{{route('detailscategorieslivres', ['slug'=>$categorie->slug, 'lang'=>$lang])}}" class="btn btn-primary voir-plus"> Afficher les livres </a></h4>
                      <p>{{ucfirst($categorie->intitule)}} ({{ $count }} @lang('message.livres'))</p>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-3">
          <div class="portfolio-info">
            ...
            <ul>
                ...
                <li><strong><a href="{{route('detailscategorieslivres', ['slug'=>$categorie->slug, 'lang'=>$lang])}}">{{strtoupper($categorie->intitule)}}</a></strong>
