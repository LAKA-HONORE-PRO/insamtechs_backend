...
<div class="container" id="all" style="transition: all 0.5s">
  ...
  <div class="row d-flex align-items-center justify-content-center" id="content_form">
    ...
    <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 my-6 d-flex align-items-center justify-content-center">
      ...
      <span class="col-12 response " id="q1" data-answer="@lang('message.pas_du_tout')" data-span-id="1" style="transition: all 0.5s">
        @lang('message.pas_du_tout') (0,5 pts)
      </span>
    ...
    <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 d-flex align-items-center justify-content-center">
      <span class="col-12 response" id="q2" data-answer="@lang('message.partiellement')" data-span-id="2" style="transition: all 0.5s">
          @lang('message.partiellement') (1 pts)
      </span>
    </div>

    <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 d-flex align-items-center justify-content-center">
      <span class="col-12 response" id="q3" data-answer="@lang('message.parfaitement')" data-span-id="3" style="transition: all 0.5s">
        @lang('message.parfaitement') (1,5 pts)
      </span>
    </div>
    ...
    <br>
      ...
      <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 d-flex align-items-center justify-content-center">
      <span class="col-12 response" id="q4" data-answer="@lang('message.totalement')" data-span-id="4" style="transition: all 0.5s">
        @lang('message.totalement') (2 pts)
      </span>
    </div>
  </div>
