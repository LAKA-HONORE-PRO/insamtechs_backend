    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container-fluid">
        ...
        <div class="row gy-4">
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item filter-app animate__animated animate__fadeInUp">
                    <div class="portfolio-wrap">
                      <figure class="skeleton-loader" data-loaded="false">
                        ...
                        <img src="{{URL::asset('assets/img/admin/filieres.jpg')}}" class="img-fluid" alt="" onload="hideSkeletonLoader(this)">
                      </figure>
          
                      <div class="portfolio-info">
                        <h4><a href="{{route('fasc', $branche->slug)}}" class="btn btn-primary voir-plus"> Afficher les domaines </a></h4>
                        <p>{{ucfirst($branche->intitule)}}</p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              <h3>Filières récentes</h3>
              <ul>
  
                  @forelse ($cats as $branch)
                  <li><strong><a href="{{route('detailsseries', $branch->slug)}}">{{strtoupper($branch->intitule)}}</a></strong>
