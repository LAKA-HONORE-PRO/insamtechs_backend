...
<div class="col-lg-12 d-flex flex-column align-items-center justify-content-center py-4">
    ...
    <div class="card row align-items-before justify-content-before">
      <div class="card-body">
        ...
        <form class="row g-3" method="post" action="{{route('question_update')}}" autocomplete="off" id="categorie_update">
          @csrf
          {{-- {{ method_field('PUT') }} --}}
...
<!--
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="question_une" name="question_une" value="{{ucfirst($question->question_une)}}" required>
            ...
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="question_deux" name="question_deux" value="{{ucfirst($question->question_deux)}}" required>
          ...
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="question_trois" name="question_trois" value="{{ucfirst($question->question_trois)}}" required>
            ...
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="question_quatre" name="question_quatre" value="{{ucfirst($question->question_quatre)}}" required>
    ...
    <!--
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="bonne_reponse" name="bonne_reponse" value="{{ucfirst($question->bonne_reponse)}}" required>
