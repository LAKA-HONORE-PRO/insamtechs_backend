...
<div class="col-lg-7">
    ...
    <div class="card row align-items-before justify-content-before">
      <div class="card-body">
        ...
        <form class="row g-3" method="post" action="{{route('user.store')}}" autocomplete="off" id="categorie_create">
          @csrf
          ...
          <div class="row">
            <div class="form-group col-12">
              <label for="password" class="form-label">Mot de passe <span style="color: red; font-weight:700">*</span></label>
            ...
            <div class="form-group col-12">
              <label for="password" class="form-label" >Rôle de l'utilisateur <span style="color: red; font-weight:700">*</span></label>
                <select name="role" id="role" class="form-select">
                  <option value="#" selected disabled>--Séléctionnez le rôle--</option>
