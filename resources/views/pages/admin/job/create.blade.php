...
<div class="pagetitle">
  <h1>Ajouter Un Job Description</h1>
  <nav>
    <ol class="breadcrumb">
...
<div class="col-lg-12 d-flex flex-column align-items-center justify-content-center py-4">
    ...
    <div class="card row align-items-before justify-content-before">
      <div class="card-body">
        ...
        <form class="row g-3" method="post" action="{{route('job.store')}}" enctype="multipart/form-data" autocomplete="off" id="formation_create" >
          @csrf
          ...
          <div class="row">
            ...
            <div class="form-group col-6">
              <label for="nombre_de_points" class="form-label">Langue du Job Description <span style="color: red">*</span></label>
