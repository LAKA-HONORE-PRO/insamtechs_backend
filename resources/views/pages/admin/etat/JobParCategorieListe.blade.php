...
<div class="row justify-content-end align-items-end">
    <a href="{{route('jobs_par_categorie')}}" class="col-3 btn btn-secondary" id="btnAdd">
        <i class=""></i>
        &nbsp;
        Retour
    </a>
...
@if(!empty($jobs))
                     ...
                     <div class="row">
                       <div>
                          ...
                          <h4 class="titre">Liste des jobs descriptions de {{$categorie->intitule}} <span><img src="{{URL::asset('assets/img/admin/logo-estuaire.png')}}" style="width:50px" alt=""> </span> </h4> 
                          <hr />
                          ...
                          <br />
                            ...
                            <table class="table table-striped animate__animated animate__fadeIn" id="for_export">
                                ...
                                <thead>
                                    ...
                                    <th style="font-size:13px">Nombre de points</th>
                            ...
                            @endphp
                                        ...
                                        <tr class="elemen">
                                            ...
                                            <td style="padding: 1px; font-size:13px">{{ucfirst($job->intitule)}}</td>

                                            <td style="padding: 1px; font-size:13px">{{ucfirst($job->nombre_de_points)}}</td>
                                            <td>
                                               ...
                                               <a href="{{route('questionjob_index', $job->slug)}}" target="_blank" class="plus">
                                                 Voir plus
                                                </a>
                                              </td>
