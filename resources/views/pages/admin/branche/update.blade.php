...
<div class="row justify-content-end align-items-end">
  <a href="{{route('branche.index')}}" class="col-3 btn btn-secondary" id="btnAdd"  style="background-color: #0f70b6; border:none">
      <i class=""></i>
      &nbsp;
      Liste des filières
  </a>
...
<div class="col-lg-7">
    ...
    <div class="card row align-items-before justify-content-before">
      <div class="card-body">
        ...
        <form class="row g-3" method="post" action="{{route('branche.update', $branche->id)}}" autocomplete="off" id="branche_update">
          @csrf
          {{ method_field('PUT') }}
          ...
          <div class="row">
            <div class="form-group col-12">
              ...
              <input type="text" class="form-control" value="{{ucfirst($branche->intitule)}}" id="intitule" name="intitule">
              <br>
            </div>
          </div>
 ...
 if(intitule == '')
  {
    Swal.fire({
      ...
      document.querySelector('#branche_update').submit();
  }
